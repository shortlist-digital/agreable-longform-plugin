...
class EmailController {
  ...
  function __construct($post_data, $post_array){
    ...
    if (($post_array['post_status'] == 'publish') && ($this->post_object->post_status == 'publish') && ($this->post_object->post_type == 'longform')) {
  ...
  public function build_message(){
    ...
    return view('@AgreableLongformPlugin/email.twig', array(
